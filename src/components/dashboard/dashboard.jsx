...
return (
  <div className="dashboard-stack">
    ...
    <div className="dashboard-col">
       {/* HOURLY FORECAST */}
    <div className="short-card hourly-card">
    ...
    {/* WEEKLY FORECAST */}
    <div className="short-card weekly-card">
    ...
    <div className="dashboard-col">
      {/* PRECIPITATION */}
    <div className="short-card expandable-card precip-card">
    ...
    {/* WIND */}
    <div className="short-card expandable-card wind-card">
      <div className="card-default">
        <h3>Wind</h3>
        <div className="grid-substats">
          <div>
    ...
    <div className="dashboard-col">
     {/* AQI */}
    <div className="short-card expandable-card aqi-card">
      <div className="card-default">
        <h3>AQI</h3>
        <p className="large-stat">{airQuality?.aqi ?? "N/A"}</p>
        <p className="sub-label">{getAqiStatus(airQuality?.aqi)}</p>
      </div>
    ...
    {/* UV INDEX */}
    <div className="short-card expandable-card uv-card">
      <div className="card-default">
        <h3>UV Index</h3>
        <p className="large-stat">
          {dailyUv[0] ?? "N/A"}
        </p>
        <p className="sub-label">{getUvLabel(dailyUv[0])}</p>
      </div>
